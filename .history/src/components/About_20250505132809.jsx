...
import React from "react";
import { FaFacebook, FaGithub, FaNodeJs, FaReact, FaYoutube } from "react-icons/fa";
...
const AboutMe = () => {
 ...
 <a
   ...
   className="group relative inline-flex h-10 w-10 items-center justify-center rounded-full bg-green-600 text-white hover:bg-[#ff0000] hover:w-36 transition-all overflow-hidden"
 >
