        ...
        <>
            <div name="Home" className='max-w-screen-2xl container m-auto mb-10'>
                ...
                <div className='flex md:flex-row flex-col md:mt-10  '>
                    <div className='md:w-[60%] space-y-2 order-2 md:order-1 text-gray-600'>
                        <span className=' text-xl font-bold text-[#ff695f] mb-50'>Welcome to My Portfolio</span>
