...
function Portfolio() {
  ...
  },
  {
    ...
    description: "Namrata Universal website UI built with React.js and Tailwind CSS, offering scalable web solutions, design, development, and digital marketing.",
  ...
  return (
    <>
      <section name="Portfolio" className=' py-4 m-auto  min-h-screen'>
