  ...
  return (
    <>
      <div name="About" className="max-w-screen-2xl container m-auto mb-10 px-4 md:px-20 min-h-screen">
        <h2 className="text-3xl font-bold text-gray-300 mb-8">About Me</h2>
        <div className="md:flex items-center space-y-8 md:space-y-0 md:space-x-8">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
              Hi! I'm <span className="font-bold text-gray-300">Shummy Ranjan Shanoo</span>, a passionate developer transitioning into software development. I have a B.Tech degree in Mechanical Engineering, which I completed in 2017. Recently, I completed a Full Stack Web Development course at Edureka, where I gained hands-on experience with technologies such as HTML, CSS, JavaScript, React, and Node.js.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed mt-4">
              I also did an unpaid internship with <span className="font-bold text-gray-300" >The Entrepreneurship Network</span>, where I worked on real-world projects. This allowed me to practically apply my skills and gain confidence in building websites and applications. My goal is to continue growing as a developer and contribute to impactful projects.
            </p>
