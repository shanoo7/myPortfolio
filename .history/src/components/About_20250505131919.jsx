...
//         <h2 className="text-3xl text-center font-bold text-white-300 mb-8">About Me</h2>
...
//             </p>
//             <p className="text-white-300 text-lg leading-relaxed mt-4">
...
//             </p>
//             <h3 className="text-xl font-semibold text-white-300 mt-6">Skills:</h3>
//             <ul className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4 text-white-300 animate-pulse">
//               {/* List of Skills */}
...
//               </li>
//             </ul>
//             <h3 className="text-xl font-semibold text-white-300 mt-6">Education:</h3>
//             <ul className="list-disc pl-5 text-white-300 mt-4">
...
const AboutMe = () => {
  return (
    <section className="w-full">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-white-300 mb-20">
            About Me
          </h2>
      </div>
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 ">
        ...
        <div className="">
          ...
          {/* Skills Grid */}
          {/* <div>
            <h3 className="text-xl font-semibold text-white-300 mb-3">Skills</h3>
            <ul className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-white-300 text-sm">
              {[
                "JavaScript",
                "React.js",
                "Node.js",
