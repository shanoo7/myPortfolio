    ...
    return (
        <>
            <div name="Home" className='relative max-w-screen-2xl container m-auto mb-10 px-4 md:px-20'>
                ...
                <img className=' absolute inset-0 w-full h-full' src="https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&cs=tinysrgb&w=600" alt="img" />
