...
<div className='absolute -top-3 -left-3 w-[200px] h-[200px] rounded-xl bg-slate-400  z-0'></div>
<div className='absolute -top-1 -left-2 w-[200px] h-[200px] rounded-xl bg-slate-500  z-0'></div> 
