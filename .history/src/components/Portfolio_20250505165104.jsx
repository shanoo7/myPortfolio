        ...
        <div className='w-full flex gap-5'>
          {
            cardItems.map((item) => (
              <div key={item.id} className=' group bg-slate-500 rounded-xl relative  w-[200px] h-[200px]'>
                ...
                <div className=' absolute w-full h-0 flex gap-2 inset-0 items-end group-hover:items-center group-hover:h-full transition-all duration-900 ease-in-out justify-center'>
