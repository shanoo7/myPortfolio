    ...
    <>
      <div name="Portfolio" className='max-w-screen-2xl container py-4 m-auto px-4 md:px-20 min-h-screen'>
        ...
        <div className=''>
          {
            cardItems.map((item) => (
              <div key={item.id} className=' bg-slate-500 relative  w-[200px] h-[200px]'>
                <img className='w-full h-full object-cover' src="https://images.pexels.com/photos/5198392/pexels-photo-5198392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
                <div className=' absolute w-full h-full flex flex-col inset-0  items-center justify-center'>
                  <h1 className=' w-full h-full'>view</h1>
                  <h2 className=' w-full h-full '>live</h2>
                </div>
              </div>
