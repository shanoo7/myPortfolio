...
function Portfolio() {
  ...
  const cardData = [
    ...
    },
    {
      id: 2,
      title: "Input",
      description: "descriptuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuion",
      badge: 19,
      link: "#",
  ...
  return (
    <>
      ...
      {/* main card div */}
      <div className=" flex w-full justify-center bg-red-500 items-center p-2">
