  ...
  const cardData = [
    {
      ...
      img: "https://images.pexels.com/photos/6612357/pexels-photo-6612357.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
    {
      id: 2,
      title: "Input",
        ...
        {cardData.map(card => (
          ...
          >
            ...
            <div className="p-2 flex justify-center">
              <a href={card.link}>
                <img
                  className="rounded-md object-cover max-h-screen"
                  src={card.img}
                  alt={card.title}
                  loading="lazy"
                />
