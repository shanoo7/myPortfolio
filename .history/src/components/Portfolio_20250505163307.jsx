        ...
        <div className=''>
          {
            cardItems.map((item) => (
              <div key={item.id} className=' bg-slate-500 relative  w-[200px] h-[200px]'>
                <img className='w-full p-1 rounded h-full object-cover' src="https://images.pexels.com/photos/5198392/pexels-photo-5198392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
