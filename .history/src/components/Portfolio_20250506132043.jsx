  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white py-20 text-center">
        <h1 className="text-5xl font-bold mb-4">Hi, I'm Alex – Creative Developer</h1>
        <p className="text-xl mb-6">I design and build immersive digital experiences for the web.</p>
