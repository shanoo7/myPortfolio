...
<div key={item.id} className='group bg-slate-500 overflow-hidden rounded-xl relative w-[200px] h-[200px]'>
  ...
  <div className='absolute inset-0 h-0 opacity-0 group-hover:opacity-100 flex gap-2 items-center justify-center group-hover:h-full transition-all duration-1000 ease-in-out bg-black/40'>
  ...
  <div className="absolute bottom-1 left-1 w-full h-full bg-gray-700 rounded-2xl opacity-20 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
  <div className="absolute bottom-2 left-2 w-full h-full bg-gray-700 rounded-2xl opacity-10 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform" />
  {/* Top Label Tag */}
