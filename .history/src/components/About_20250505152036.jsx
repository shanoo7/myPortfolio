...
const AboutMe = () => {
  return (
    <section name="About" className="w-full">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-600 mb-10 sm:mb-20">
            About Me
          </h2>
      </div>
      <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 ">
        ...
        <div className="">
          ...
          <div>
      <h3 className="text-xl font-semibold text-gray-600 mb-4">Skills</h3>
...
const SkillIcon = ({ label, bgColor, icon }) => {
  return (
    <a
      href="#"
      className={`group relative inline-flex h-10 w-10 items-center justify-center rounded-full ${bgColor} text-gray-600 hover:w-36 transition-all overflow-hidden`}
    >
