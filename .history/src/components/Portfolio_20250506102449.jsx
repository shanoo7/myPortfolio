...
<div className='absolute inset-0 flex gap-2 items-center justify-center bg-black/40 opacity-0 translate-y-5 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 ease-in-out z-10'>
