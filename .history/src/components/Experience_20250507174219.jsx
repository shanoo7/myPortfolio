  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        <h2 data-aos="zoom-out" className="text-4xl font-bold mb-2">Experience</h2>
        <p data-aos="zoom-out" className="text-gray-400">My professional journey and internship highlights</p>
      </div>

      <div data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="relative border-l-4 border-violet-500 ml-4">
        {experienceList.map((exp, index) => (
          ...
          >
           ...
           <h3 className="text-xl font-semibold  mb-1">
            ...
            <p className="text-sm ml-5 text-gray-400 mt-4">Internship Type: {exp.type}</p>
          </div>
        ))}
      </div>
    </section>
