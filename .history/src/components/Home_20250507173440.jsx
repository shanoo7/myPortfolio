...
function Home() {
    return (
        <>
            <div name="Home" className='max-w-screen-2xl container m-auto mb-10'>
                
                <div className='flex md:flex-row flex-col md:mt-10  '>
                    <div className='md:w-[60%] space-y-2 order-2 md:order-1 text-gray-500'>
                        <span className=' text-xl font-bold text-white'>Welcome to My Portfolio</span>
                        ...
                        <p data-aos="zoom-out" className='text-md md:text-xl text-justify text-gray-500'>I love crafting web applications that address actual-world issues. Being skilled in recent web technologies such as React, JavaScript, and Node.js, I aim at developing intuitive and scalable applications. Outside of coding, I am learning new technologies and refining my skills.</p>

                    </div>
                    <div data-aos="zoom-in" className='md:w-[40%] p-5 order-1'>
                ...
                <div className='flex items-center justify-between mb-10'>
                    <div data-aos="fade-right" className='space-y-3'>
                        <h1 className='text-xl font-semibold text-gray-500'>Let's Connect</h1>
                        <ul data-aos="zoom-in" className='flex space-x-4'>
                            <li>
                    ...
                    <div data-aos="fade-left" className='space-y-3 data-aos="fade-left"'>
                        <h1  className="text-xl font-semibold text-gray-500">Get in Touch</h1>
                        <ul data-aos="zoom-in" className='flex space-x-4 '>
                            <li>
                                <a href="shanoo.kumar11@gmail.com" className="text-gray-500">
                                    <MdEmail className='text-2xl cursor-pointer hover:scale-105 duration-300 text-blue-500' />
                                </a>
                            </li>
                            <li>
                                <a href="+919853914057" className="text-gray-500">
