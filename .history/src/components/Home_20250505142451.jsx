        ...
        <>
            <div name="Home" className='max-w-screen-2xl container m-auto mb-10 px-4 md:px-20'>
                ...
                <div className='flex md:flex-row flex-col md:mt-10  '>
                    <div className='md:w-1/2 space-y-2 order-2 md:order-1 text-white'>
                ...
                <div className='flex items-center justify-between mb-10'>
                    <div className='space-y-3'>
                        <h1 className='text-xl font-semibold text-white'>Let's Connect</h1>
                        <ul className='flex space-x-4'>
                            <li>
                                <a href="https://github.com/shanoo7" target="_blank">
                                    <FaGithub className='text-2xl cursor-pointer hover:scale-105 duration-300 text-white' />
                                </a>
                            </li>
                            <li>
                    ...
                    <div className='space-y-3'>
                        ...
                        <ul className='flex space-x-4'>
                            <li>
                                <a href="shanoo.kumar11@gmail.com" className="text-white">
                                    <MdEmail className='text-2xl cursor-pointer hover:scale-105 duration-300 text-blue-500' />
                                </a>
                            </li>
                            <li>
                                <a href="+919853914057" className="text-white">
