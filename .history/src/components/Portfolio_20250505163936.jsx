        ...
        <div className='w-full flex gap-5'>
          {
            cardItems.map((item) => (
              <div key={item.id} className=' bg-slate-500 rounded-xl relative  w-[200px] h-[200px]'>
                ...
                <div className=' absolute w-full h-full flex gap-2 inset-0  items-center justify-center'>
                  <h1 className=' bg-yellow-400 flex justify-center items-center rounded-full w-[40px] h-[40px]'>w</h1>
                  <h2 className=' bg-yellow-400 flex justify-center items-center rounded-full w-[40px] h-[40px]'>L</h2>
                </div>
              </div>
