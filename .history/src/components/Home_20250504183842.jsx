            ...
            <div name="Home" className='max-w-screen-2xl container m-auto mb-10 px-4 md:px-20'>
                <div className='flex md:flex-row flex-col md:mt-10  '>
                    <div className='md:w-1/2 space-y-2 order-2 md:order-1 text-gray-500'>
                        ...
                        <p className='text-sm md:text-md text-justify text-white'>I'm passionate about building web applications that solve real-world problems. With expertise in modern web technologies like React, JavaScript, and Node.js, I strive to create intuitive and scalable applications. When I'm not coding, you can find me learning new technologies and improving my craft.</p>
                        ...
                        <ul className='flex space-x-4 animate-bounce'>
                            <li>
                                <a href="https://github.com/shanoo7" target="_blank">
                                    <FaGithub className='text-2xl cursor-pointer hover:scale-105 duration-300 text-gray-400' />
                                </a>
                            </li>
                            <li>
