...
<div className='absolute -top-2 -left-2 w-[200px] h-[200px] rounded-xl bg-slate-300  z-0'></div>
<div className='absolute -top-1 -left-1 w-[200px] h-[200px] rounded-xl bg-slate-400  z-0'></div> 
