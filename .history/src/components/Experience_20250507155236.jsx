    ...
    >
      ...
      <div className="relative border-l-4 border-violet-500 ml-4">
        {experienceList.map((exp, index) => (
          <div
            key={index}
            className="mb-10 ml-6 p-6 duration-300 relative"
          >
            <div className="absolute -left-4 top-6 w-10 h-10 bg-violet-500  flex items-center justify-center rounded-full shadow-lg">
              <FaBriefcase className="text-lg" />
            </div>

            <h3 className="text-xl font-semibold  mb-1 ml-5">
              {exp.focus} - {exp.role}
            </h3>
