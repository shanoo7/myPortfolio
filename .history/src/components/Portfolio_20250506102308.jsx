...
<div key={item.id} className='group bg-slate-500 overflow-hidden rounded-xl relative w-[200px] h-[200px]'>
  ...
  <div className='absolute inset-0 h-[-1] flex gap-2 items-center justify-center group-hover:h-full transition-all duration-1000 ease-in-out bg-black/40 z-10'>
