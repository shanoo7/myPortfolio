    ...
    <>
      <div name="Portfolio" className='max-w-screen-2xl container py-4 m-auto px-4 md:px-20 min-h-screen'>
        ...
        <div className='  bg-green-500'>
          {
            cardItems.map((item)=>(
              <div key={item.id} className=' relative bg-slate-500'>
                <div className=' w-full relative'>
<img className=' w-[200px] h-[200px]' src="https://images.pexels.com/photos/5198392/pexels-photo-5198392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
<h1 className=' w-full h-full absolute inset-10'>view</h1>
<h2 className=' w-full h-full absolute inset-0'>live</h2>
                </div>
