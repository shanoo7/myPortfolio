    ...
    <>
      <div name="Portfolio" className='max-w-screen-2xl container py-4 m-auto px-4 md:px-20 min-h-screen'>
        ...
        <div className='w-full flex gap-5'>
          {
            cardItems.map((item) => (
              <div key={item.id} className=' bg-slate-500 rounded-xl relative  w-[200px] h-[200px]'>
                <img className='w-full p-1 h-full rounded-xl object-cover' src="https://images.pexels.com/photos/5198392/pexels-photo-5198392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
                <div className=' absolute w-full h-full flex gap-2 inset-0 items-end hover:items-center transition-all duration-500 ease-in-out justify-center'>
                  <h1 className=' bg-yellow-400 flex justify-center items-center rounded-full w-[40px] h-[40px] transition-all duration-500 ease-in-out'>w</h1>
                  <h2 className=' bg-green-600 flex justify-center items-center rounded-full w-[40px] h-[40px] transition-all duration-500 ease-in-out>L</h2>
                </div>
              </div>
