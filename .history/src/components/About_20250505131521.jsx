...
const AboutMe = () => {
  return (
    <section className="w-full">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-300 mb-20">
            About Me
          </h2>
      </div>
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 ">
        ...
        <div className="">
          ...
          Hello! I am Shummy Ranjan Shanoo, a passionate and self-motivated coder shifting from the Mechanical Engineering field to a professional software development career. I graduated with a B.Tech in Mechanical Engineering in 2017 and have recently done a Full Stack Web Development course from Edureka.
          ...
          {/* Skills Grid */}
          {/* <div>
            <h3 className="text-xl font-semibold text-gray-300 mb-3">Skills</h3>
