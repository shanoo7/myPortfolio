  ...
  return (
    <>
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-white my-5">
          ...
          <h2 className="text-sm md:text-md text-gray-300">
          With a lot of experience working with MERN stack technologies (MongoDB, Express.js, React, Node.js), being a full-stack developer, I've used the stack to develop high-performance, stable, and scalable web applications. Below are some of my most significant projects provided below where I demonstrate my skills in developing and deploying web applications as well as designing them. They think about how I use the MERN stack to create contemporary, high-performance websites with a great user experience. Take a look at each one to see how I've utilized these technologies!
