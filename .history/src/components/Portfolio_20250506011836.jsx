        ...
        <div className='w-full flex gap-5'>
          {
            cardItems.map((item) => (
              <div key={item.id} className='group bg-slate-500 overflow-hidden rounded-xl relative  w-[200px] h-[200px]'>
                ...
                <div className=' absolute w-full h-0 -z-10 flex gap-2 inset-0 items-center group-hover:h-full group-hover: z-10 transition-all duration-1000 ease-in-out justify-center'>
