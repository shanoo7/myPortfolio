...
//         <form onSubmit={handleSubmit} className=" shadow-red-500 hover:shadow-red-200 m-auto p-5 rounded-md shadow-lg space-y-6 max-w-xl">
    ...
    <div name="Contact"  className="min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white p-4 flex flex-col items-center pb-8">
      <div className="w-full max-w-6xl mt-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full">
          {/* Left Contact Info */}
          <div className="bg-gray-800 p-8 rounded-mdl shadow-xl w-full md:w-1/2">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  <div className={`${item.iconBg} p-4 rounded-md transform transition-transform duration-300 group-hover:translate-y-2`}>
          ...
          <form
            ...
            className="bg-gray-800 p-8 rounded-mdl shadow-xl w-full md:w-1/2"
          >
                ...
                {step.type === 'textarea' ? (
                  <>
                    <textarea
                      ...
                      rows="4"
                      className="w-full p-4 bg-gray-700 rounded-mdl focus:outline-none focus:ring-2 focus:ring-[#03a4ed] text-white"
                    />
            ...
            <div className="flex justify-between mt-8">
              {currentStep > 0 && (
                <button
                  type="button"
                  onClick={handleBack}
                  className="px-6 py-3 bg-[#ff695f] hover:bg-[#ff6a5fd3] rounded-md transition duration-300"
                >
                  Back
                </button>
              )}
              {currentStep < steps.length - 1 ? (
                <button
                  type="button"
                  onClick={handleNext}
                  className="ml-auto px-6 py-3 bg-[#03a4ed] hover:bg-[#03a3edbc] rounded-md transition duration-300"
                >
                  Next
                </button>
              ) : (
                <button
                  type="submit"
                  className="ml-auto px-6 py-3 bg-green-600 hover:bg-green-500 rounded-md transition duration-300 flex items-center gap-2"
                >
            ...
            <div className="flex justify-center mt-8 gap-2">
              {steps.map((_, index) => (
                <div
                  key={index}
                  className={`h-2 rounded-mdll transition-all duration-300 ${
