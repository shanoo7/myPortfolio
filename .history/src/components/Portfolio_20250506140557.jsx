        ...
        {cardData.map(card => (
          ...
          >
            ...
            <div className="px-4 pb-3">
              <div>
                <a className='relative' href={card.link}>
                  ...
                  <div className="absolute top-0 right-3 rounded-full bg-violet-600 text-gray-200 w-6 h-6 text-center text-xs flex items-center justify-center">
              {card.badge}
            </div>
            <div className="absolute top-10 right-3 rounded-full bg-violet-600 text-gray-200 w-6 h-6 text-center text-xs flex items-center justify-center">
              {card.badge}
            </div>
                </a>
