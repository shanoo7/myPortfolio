...
const AboutMe = () => {
  return (
    <section name="About" className="w-full">
      ...
      <h2 data-aos="zoom-out" className="text-3xl md:text-4xl font-bold text-white mb-10 sm:mb-20">
            About Me
          </h2>
      </div>
      <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 ">
        ...
        {/* Text Section */}
        <div className="">
          <p data-aos="zoom-out-right" className="text-gray-500 mb-4 leading-relaxed">
          ...
          <p data-aos="zoom-out-right" className="text-gray-500 mb-6 leading-relaxed">
     ...
     data-aos-duration="3000" className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 xl:grid-cols-4 gap-8">
        {/* JavaScript */}
        <SkillIcon data-aos="zoom-out"  label="JavaScript" bgColor="bg-yellow-400" icon={<DiJavascript1 />} />
        ...
        {/* GitHub */}
        <SkillIcon label="GitHub" bgColor="bg-gray-700" icon={<FaGithub />} />
...
const SkillIcon = ({ label, bgColor, icon }) => {
  return (
    <a
      href="#"
      className={`group relative inline-flex h-10 w-10 items-center justify-center rounded-full ${bgColor} hover:w-36 transition-all overflow-hidden`}
    >
