...
function Contact() {
  ...
  return (
    <div name="Contact" className="max-w-screen-2xl container py-4 m-auto px-4 md:px-20 min-h-screen">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="shadow-red-500 hover:shadow-red-200 m-auto p-5 rounded-lg  space-y-6 max-w-xl bg-gray-300 dark:bg-gray-900">
