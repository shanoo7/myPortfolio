...
<div key={item.id} className="group bg-slate-500 overflow-hidden rounded-xl relative w-[200px] h-[200px]">
  ...
  <div className="absolute inset-0 w-full h-full flex gap-2 items-center justify-center group-hover:items-end p-4 transition-all duration-700 ease-in-out z-10">
