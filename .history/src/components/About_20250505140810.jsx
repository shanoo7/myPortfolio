...
const AboutMe = () => {
  return (
    <section className="w-full px-10">
      ...
      <div className="grid grid-cols-3 xs:grid-cols-2 sm:grid-cols-4 md:grid-cols-3 xl:grid-cols-4 gap-4">
        {/* JavaScript */}
        ...
        {/* Redux */}
        <SkillIcon label="Redux" bgColor="bg-purple-600" icon={<FaGithub />} />
