...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container text-gray-400 py-4 shadow-sm  m-auto px-4 md:px-20  ${sticky && "fixed top-0 left-0 right-0 bg-gray-700  shadow-2xl shadow-gray-600 duration-300 transition-all ease-in-out z-50"}`}>
